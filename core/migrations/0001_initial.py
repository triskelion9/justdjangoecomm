# Generated by Django 2.2.13 on 2021-03-20 22:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'SportsWear'), ('OW', 'Outwear')], default='S', max_length=100)),
                ('label', models.CharField(choices=[('P', 'primary'), ('S', 'secondary'), ('D', 'danger')], default='P', max_length=100)),
